...
function FeaturedNews() {
    ...
    return (
    <div className='w-screen md:p-10 p-5 pt-10 pb-10 bg-gray-100 '>
        ...
        <div className='grid lg:grid-cols-3 gap-10 md:grid-cols-2 '>
            ...
            <div key={index}>
                <div className='transition-all duration-500 ease-in-out w-full bg-cover bg-center drop-shadow-x hover:opacity-90' style={{'backgroundImage': `url(${FeaturedNewsData.cover}`}} onClick={() => { router.push(`/news/${FeaturedNewsData.id}`)}} > 
                    <div className=' w-full h-96 flex justify-end items-start flex-col p-5 bg-gradient-to-b from-transparent to-black/90 backdrop-brightness-150'>
                        <div className=''>
                            ...
                            <p className='text-white/60 text-sm'>{FeaturedNewsData.text}... </p>
