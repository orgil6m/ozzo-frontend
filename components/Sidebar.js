    ...
    const LoggedUser = () =>{
        return (
            <div className="flex flex-col justify-around items-between text-gray-500 mt-10">
                ...
                <>
                <Link href='/hr' >
                    <a onClick={() => setShowSidebar(!showSidebar)} className={`transition-all duration-500 ease-in-out m-2 pl-3 py-2 pt-2 border-l-2 text-base hover:text-black hover:border-red-500 flex items-center ${router.pathname == "/hr" ? "border-red-500  text-black " : "border-white"}`}>
