...
const FeaturedContact = () => {
  ...
  return (
    <div className="drop-shadow-lg bg-gray-100 lg:px-32 md:px-20 lg:py-10 p-5">
        <div className='grid lg:grid-cols-4 lg:gap-10 gap-5 md:grid-cols-2 grid-col-1 '>
            <div className="col-span-1">
                 <div className='w-full pt-5 md:mb-10 mb-5'>
                    <div className='transition-all duration-500 ease-in-out lg:w-full flex-col font-semibold md:text-xl text-lg flex  text-gray-800 mb-5 '> 
                        <p className='w-4/6 uppercase'>{socials.title}</p>
                        <div className='transition-all duration-1000 ease-in-out h-1 w-10 bg-red-500 mt-2'></div>
                    </div>
                </div>
                <div className="flex items-center  hover:underline my-2">
                    <div className="bg-gradient-to-r from-sky-500 to-sky-600 rounded-full w-8 h-8 flex items-center justify-center">
                ...
                <div className="flex items-center  hover:underline my-2">
                    <div className="bg-gradient-to-r from-pink-400 to-pink-500 rounded-full w-8 h-8 flex items-center justify-center">
                ...
                <div className="flex items-center  hover:underline my-2">
                    <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-full w-8 h-8 flex items-center justify-center">
            ...
            <div className="col-span-1">
                <div className='w-full pt-5 md:mb-10 mb-5'>
                    <div className='transition-all duration-500 ease-in-out lg:w-full flex-col font-semibold md:text-xl text-lg flex  text-gray-800 mb-5 '> 
                        ...
                        <div className='transition-all duration-1000 ease-in-out h-1 w-10 bg-violet-500 mt-2'></div>
                    </div>
                </div>
            ...
            <div className="md:col-span-2 mb-10 ">
                <div className=' w-full pt-5 md:mb-10 mb-5 '>
                    <div className='transition-all duration-500 ease-in-out lg:w-full flex-col font-semibold md:text-xl text-lg flex  text-gray-800 mb-5 '> 
                        ...
                        <div className='transition-all duration-1000 ease-in-out h-1 w-10 bg-sky-500 mt-2'></div>
                    </div>
                </div>
