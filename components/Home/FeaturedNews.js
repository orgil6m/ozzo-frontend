...
const FeaturedNews = () =>{
    ...
    <div className='w-full py-10 cursor-default'>
        <div className='transition-all duration-500 ease-in-out lg:w-full font-semibold md:text-2xl text-lg flex items-center text-gray-800 mb-10'> 
            ...
            <div className='md:flex hidden transition-all duration-500 ease-in-out hover:translate-x-2  w-3/6 h-10 font-thin text-base items-center justify-end ' onClick={() => { router.push('/news')}}>
                {t.more}
