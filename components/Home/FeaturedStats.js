...
function FeaturedStats() {
    ...
    return (
     <div className=" grid md:grid-cols-3 grid-cols-2 md:gap-10 gap-5 lg:my-10 my-5 cursor-default">
        {StatsLocale[l].items.map((stats, index) =>(
            <div key={index}>
                ...
                hover:border-gray-300 my-3 relative group' onClick={() =>{setShow(!show)}}>
                  ...
                  <p className='my-2 font-semibold uppercase pt-5 md:text-base text-xs'>
                      {stats.title}
                  </p>
                  ...
                  {!show ?    
                  <>
                    <p className='md:text-3xl text-lg font-black text-gray-700'><CountUp end={stats.number} /></p>
