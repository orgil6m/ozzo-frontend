            ...
            <div className="col-span-1">
                ...
                <a href="https://www.linkedin.com/in/ozzo-llc">
                    <div className=" flex items-center hover:underline my-1">
                        <div className="bg-black/80   rounded-md w-6 h-6 flex items-center justify-center">
                ...
                <div className=" flex flex-col justify-center">
                    {Numbers.map((numbers, index) => (
                        <div key={index}>
                            <a href={`tel: ${numbers}`}>
                              <div className="flex items-center hover:underline my-1">
                                    <div className="bg-emerald-500 rounded-md w-6 h-6 flex items-center justify-center">
                                        <svg  className="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
                                            <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                                        </svg>
                                    </div>
                                    <p className="font-thin text-sm p-2">{numbers}</p>
                                </div>
                            </a>
                        </div>
                    ))}
                ...
                {Addresses[l].address.map((address, index) => (
                    <div key={index} >
                       <div className="flex items-center hover:underline my-1">
                            ...
                            <p className="font-thin text-sm p-2">{address}</p>
                        </div>
                    </div>
                ))}
            </div>
