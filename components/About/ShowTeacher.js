              ...
              <div className='md:flex lg:w-full '>
                    ...
                    <div className='my-5 flex justify-center'>
                      ...
                      <div className='mx-1 hover:opacity-90'>
                                <a href={profile.linkedin} >
                                  <div className=" flex items-center hover:underline my-1">
                                      <div className="bg-black/80 from-sky-600 to-sky-700 rounded-md w-6 h-6 flex items-center justify-center">
                      ...
                      <div className='mx-1 hover:opacity-90'>
                                <a href={profile.facebook} >
                                  <div className=" flex items-center hover:underline my-1">
                                    <div className="bg-black/80 from-sky-500 to-sky-600 rounded-md w-6 h-6 flex items-center justify-center">
                      ...
                      <div className='mx-1 hover:opacity-90'>
                                <a href={profile.instagram} >
                                  <div className=" flex items-center hover:underline my-1">
                                    <div className="bg-black/80 from-fuchsia-400 to-fuchsia-500 rounded-md w-6 h-6 flex items-center justify-center">
                      ...
                      {profile.youtube ? 
                        <div className='mx-1 hover:opacity-90'>
                                  <a href={profile.youtube} >
                                    <div className=" flex items-center hover:underline my-1">
                                      <div className="bg-black/80 from-red-500 to-red-600 rounded-md w-6 h-6 flex items-center justify-center">
                      ...
                      {profile.email ? 
                        <div className='mx-1 hover:opacity-90'>
                                    <a href="mailto:${profile.mail}" >
                                      <div className=" flex items-center hover:underline my-1">
                                        <div className="bg-black/80 from-emerald-400 to-emerald-500 rounded-md w-6 h-6 flex items-center justify-center">
                      ...
                      {profile.website ? 
                        <div className='mx-1 hover:opacity-90'>
                                  <a href={profile.website} >
                                    <div className=" flex items-center hover:underline my-1">
                                        <div className="bg-black/80 from-indigo-400 to-indigo-500 rounded-lg w-6 h-6 flex items-center justify-center">
                     ...
                     <div className='my-5 '>
                       ...
                       <p className='uppercase text-gray-700 font-bold mb-2'>
                         {profile.skills[l].title}
                       </p>
                      {profile.skills[l].skill.map((skills, index) => (
                        <div key={index}>
                          <div className='m-1'>
                ...
                <div className='md:w-2/3  md:mx-0 mx-10 md:pr-10'>
                  <div className='mt-10 flex text-lg text-gray-700 font-medium'>
                    <p className='mr-2'>{profile.firstname[l]} {profile.lastname[l]}</p> 
                  </div>
                   <div className='flex text-sm text-gray-700 font-light'>
                    <p className='mr-2'>{profile.title[l]}</p> 
                  </div>
                  ...
                  <div className='w-full text-gray-700 mt-5 mr-5'>
                    <p className='uppercase font-bold'>{profile.education[l].title}</p>
                    <div>
                       {profile.education[l].schools.map((school, index) =>(
                          <div key={index}>
                            <div className='my-3'>
                  ...
                  <div className='w-full text-gray-700 mt-5 mb-10 mr-5'>
                    <p className='uppercase font-bold'>{profile.experience[l].title}</p>
                     <div>
                       {profile.experience[l].works.map((school, index) =>(
                          <div key={index}>
                            <div className='my-3'>
