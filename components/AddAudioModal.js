...
const EditAudioModal = ({setAddAudioModal, setScrollStop , api})=>{
    ...
    const uploadAudio = (param) => {
        ...
        .then(data => {
            ...
            setAllData(data.secure_url, audioName, secondFormat(Math.floor(data.duration)))
        })
    ...
    return   (
          <div className="transition-all duration-300 ease-in-out flex justify-center items-center fixed inset-0 z-50 outline-none focus:outline-none cursor-default" >
            <div className='w-screen h-screen fixed bg-black/30 backdrop-blur-sm inset-0' onClick={() => {setAddAudioModal(false); setScrollStop(false)}}></div>
            ...
            onClick={() => {setAddAudioModal(false); setScrollStop(false)}}>
            ...
            <div className='w-full flex justify-center'>
                ...
                type='button' onClick={() => uploadData()}>
                    Хадгалах
                </button>
            </div>
            </>
