...
const Positions =() =>{
    ...
    return (
        ...
        <Head>
            <title> Ажлын байр | ОЗЗО ХХК</title>
        </Head>
        ...
        <div className='w-full lg:px-32 md:px-20 lg:py-10 p-5 '>
            ...
            <div className="lg:mb-10 mb-5 flex cursor-default">
                ...
                <p className="transition-all duration-300 ease-in-out text-sm text-black pr-2 " onClick={() => router.push("/hr")}> Ажлын байр </p>
            </div>
            {/* TITLE */}
            <div className='lg:w-full font-semibold text-xl flex items-center text-gray-800 my-10'> 
                ...
                <p className='uppercase'>Ажлын байр</p>
            </div>
            {/* NEW BUTTON */}
            <div className='md:mt-0 mt-10 flex'>
                <div className="transition-all duration-300 ease-in-out hover:text-white hover:bg-green-500 flex items-center px-5 upper bg-green-100 py-2 rounded-md  text-green-500 font-medium "  onClick={()=> router.push("/hr/positions/new")}>
            ...
            <div className='overflow-scroll w-full'>
                ...
                <table className="w-full text-sm text-left text-gray-500 my-10 ">
                    ...
                    data.map((row, index) => (
                        ...
                        :
                        <td scope="row" className=" font-medium text-gray-900">
                            <div className='w-20 h-20 flex bg-gray-100 justify-center items-center m-2 rounded-sm' onClick={()=> router.push("/hr/positions/"+row._id)}>
