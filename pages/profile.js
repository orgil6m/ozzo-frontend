...
const Profile = () => {
  ...
  const getData = () => {
    ...
    if (!user || user === undefined) {
      ...
      user.informations[l].skills &&
        setSkills(user.informations[l].skills.skill);
      user.informations[l].education &&
        setSchools(user.informations[l].education.schools);
      user.informations[l].experience &&
        setExp(user.informations[l].experience.works);
  ...
  const deleteExp = (index) => {
    setExp([...exp.slice(0, index), ...exp.slice(index + 1, exp.length)]);
  };
  const uploadProfilePhoto = (photo) => {
    ...
    if (!photo || photo === undefined) {
      dispatch({
        type: "NOTIFY",
        payload: { error: message.coverPhoto_error },
      });
      return;
    }
          ...
          <div className="flex flex-col lg:pl-32 md:pl-20 p-5 text-gray-700">
            {profilephoto ? (
              <div className="transition-all duration-300 ease-in-out aspect-1 overflow-hidden w-full bg-cover bg-center rounded-lg mb-10 mt-5  ">
                ...
                >
                  <div
                    className="transition-all duration-300 ease-in-out absolute top-5 right-5 rounded-full bg-white/20 text-white hover:bg-white/50"
                    onClick={() =>
                      dispatch({
                        type: "NOTIFY",
                        payload: { error: message.photoChange_error },
                      })
                    }
                  >
                    <svg
              ...
              <div
                className={`transition-all duration-300 ease-in-out aspect-1 overflow-hidden w-full bg-cover bg-center rounded-lg mb-10 mt-5 flex justify-center items-center `}
              >
                <input
                  ref={fileRef}
                  onChange={(e) => {
                ...
                <div
                  ...
                  className={`w-full aspect-1 flex bg-cover bg-center flex-col justify-center items-center rounded-3xl p-5 border-2  border-dashed `}
                >
                  <svg
                    className="h-10 w-10"
                    viewBox="0 0 20 20"
                  ...
                  <div className="text-xs text-gray-500 my-1">
                    <p>
                      Зөвшөөрөх Файл:{" "}
                      <span className="font-medium text-black">png, jpg</span>
                    </p>
                  </div>
                  ...
                  <div className="text-xs text-gray-500 my-1">
                    <p>
                      Файлын дээд хэмжээ:{" "}
                      <span className="font-medium text-black">2mb</span>
                    </p>
                  </div>
                  ...
                  <div className="text-xs text-gray-500 my-1">
                    <p>
                      Зургийн харьцаа:{" "}
                      <span className="font-medium text-black"> 1:1</span>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-center">
              <p className="font-semibold uppercase my-5 text-lg">
                {Profile.profile}
              </p>
              ...
              {profileInfos.map((profile, index) => (
                <div key={index}>
                  ...
                  <input
                    ...
                    autoComplete="false"
                    onChange={(e) =>
                      setProfileInfos(e.target.value, profile.action)
                    }
            ...
            <div className="w-full my-1">
              ...
              <div className="relative flex">
                <input
                  className="transition-all duration-300 ease-in-out w-full outline-none border text-sm border-gray-200 rounded-md h-10 px-2 focus:border-sky-500 font-normal "
                  id="password"
                  name="password"
                ...
                {passwordShow ? (
                  <svg
                    className="h-4 w-4 absolute right-3 top-3 text-gray-500 hover:text-gray-700"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth={2}
              ...
              {socials.map((social, index) => (
                <div key={index}>
                  ...
                  <input
                    ...
                    value={social.val || ""}
                    onChange={(e) =>
                      setProfileSocials(e.target.value, social.action)
                    }
          ...
          <div className="flex flex-col lg:w-10/12 text-gray-700 p-5 md:mr-16 mr-0  ">
            <div className="flex w-full mt-5 justify-between items-center uppercase">
              {tabs.map((tab, index) => (
                <div
                  key={index}
                  className={`transition-all h-10 m-1 md:text-sm text-xs duration-300 ease-in-out font-semibold w-full flex justify-center rounded-md items-center text-center hover:bg-sky-100 hover:text-sky-500 ${
                    tabIndex === index
            ...
            {tabIndex === 0 ? (
              <div>
                ...
                <div className="my-10 w-full z-0">
                  {skills &&
                    skills.map((skill, index) => (
                      <div key={index} className="flex flex-col mb-10 relative">
                        <button
                          className="absolute -top-5 right-0 transition-all duration-300 ease-in-out hover:bg-red-100 hover:text-red-500 m-2 rounded-md"
                          type="button"
                        ...
                        <label># {index + 1}</label>
                        <input
                          className="transition-all w-full duration-300 ease-in-out my-2 outline-none border border-gray-200 rounded-md h-10 px-2 focus:border-sky-300 font-normal text-sm placeholder:text-black z-0"
                          id={skill}
                          name={skills}
                          type="text"
                          value={skill}
                  ...
                  <div className="w-full grid grid-cols-2 gap-5">
                    <button
                      className=" bg-sky-500 h-10 rounded-md text-white transition-all duration-300 ease-in-out hover:opacity-80"
                      onClick={() => addFieldSkills()}
                      type="button"
                    >
                      {Profile.add}
                    </button>
                    {loading ? (
                      <div className="bg-emerald-100 h-10 rounded-md  transition-all duration-300 ease-in-out  flex justify-center items-center">
                        <div
                          ...
                          style={{
                            borderColor:
                              "rgb(16 185 129) transparent rgb(16 185 129) transparent",
                          }}
                        ></div>
                      </div>
                    ) : (
                      <button
                        className=" bg-emerald-500 h-10 rounded-md text-white transition-all duration-300 ease-in-out hover:opacity-80"
                        onClick={() => UpdateUser(auth.user._id)}
                        type="button"
                      >
                        {Profile.save}
                      </button>
              ...
              <div>
                ...
                <div className="my-10">
                    ...
                    schools.map((school, index) => (
                      <div key={index} className="flex flex-col mb-10 relative">
                        ...
                        <input
                          ...
                          value={school.name || ""}
                          onChange={(e) =>
                            updateSchoolName(index, e.target.value)
                          }
                        />
                        <label>{Profile.degree}</label>
                        <input
                          className="transition-all duration-300 ease-in-out my-2 outline-none border border-gray-200 rounded-md h-10 px-2 focus:border-sky-300 font-normal text-sm placeholder:text-black"
                          id="degree"
                          name="degree"
                          ...
                          value={school.degree || ""}
                          onChange={(e) =>
                            updateSchoolDegree(index, e.target.value)
                          }
                        />
                        <label>{Profile.years} (20**-20**)</label>
                        <input
                          className="transition-all duration-300 ease-in-out my-2 outline-none border border-gray-200 rounded-md h-10 px-2 focus:border-sky-300 font-normal text-sm placeholder:text-black"
                          id="schoolYears"
                          name="schoolYears"
                          ...
                          value={school.years || ""}
                          onChange={(e) =>
                            updateSchoolYear(index, e.target.value)
                          }
                        />
                      </div>
                    ))}
                  <div className="w-full grid grid-cols-2 gap-5">
                    <button
                      className=" bg-sky-500 h-10 px-8 rounded-md text-white transition-all duration-300 ease-in-out hover:opacity-80"
                      onClick={() => addFieldSchools()}
                      type="button"
                    >
                      {Profile.add}
                    </button>
