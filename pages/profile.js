            ...
            <div className="w-full grid md:grid-cols-2 gap-10">
                ...
                <form>
                    <div className='flex flex-col lg:w-10/12 text-gray-700 p-5 md:mr-16 mr-0  '>
                        ...
                        {tabs.map((tab, index) => ( 
                            <div key={index} className={`transition-all h-10 m-1 md:text-sm text-xs duration-300 ease-in-out font-semibold w-full flex justify-center rounded-md items-center text-center hover:bg-sky-100 hover:text-sky-500 ${tabIndex===index ? "bg-sky-100 text-sky-500 " : "bg-gray-100/80"}`} onClick={() => setTabIndex(index)}>
                                <p>{tab.title}</p>
                            </div>
                        ))}
                        </div>
                        ...
                        <div>
                            ...
                            <div className='my-10 w-full z-0'>
                                ...
                                <div key={index} className="flex flex-col mb-10 relative">
                                        <button className='absolute -top-5 right-0 transition-all duration-300 ease-in-out hover:bg-red-100 hover:text-red-500 m-2 rounded-md' type='button' onClick={() => deleteSkill(index)}>
