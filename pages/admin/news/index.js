...
const News = () => {
    ...
    return (
        <div className='pt-20 cursor-default'>
            <Head>
                <title>Мэдээллүүд | ОЗЗО ХХК</title>
            </Head>
            ...
            <div className="lg:mb-10 mb-5 flex cursor-default md:mt-5">
                ...
                <p className="transition-all duration-300 ease-in-out text-sm pr-2 text-black" onClick={() => router.push("/admin/users")}> Мэдээллүүд </p>
            </div>
            </div>
        </div>
    )
