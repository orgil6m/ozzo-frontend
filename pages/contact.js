      ...
      <div className="lg:px-32 md:px-20 lg:mt-10 p-5">
        ...
        <div className="grid lg:grid-cols-2 lg:gap-20 mt-5">
              ...
              <div key={index}>
                <a href={`tel: ${numbers.number}`}>
                  <div className="flex items-start text-gray-700">
                    ...
                    <p className="font-thin my-1 mx-2 hover:underline">
                      {" "}
                      {numbers.title} :{" "}
                      <span className="font-medium">{numbers.number}</span>{" "}
                    </p>
                  </div>
                </a>
              </div>
          ...
          <div>
            ...
            <div className="flex">
              <input
                className="transition-all duration-300 ease-in-out mr-5 appearance-none block w-full text-gray-700 border focus:border-indigo-400 rounded-md py-2 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                id="grid-first-name"
                type="text"
              ...
              />
              <input
                className="transition-all duration-300 ease-in-out appearance-none block w-full  text-gray-700 border focus:border-indigo-400 rounded-md py-2 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                id="grid-first-name"
                type="text"
                placeholder={placeholder[l].email}
                value={email}
            ...
            <div className="lg:mb-0 mb-20">
              <textarea
                className="transition-all duration-300 ease-in-out resize-none h-40 mr-5 appearance-none block w-full text-gray-700 border focus:border-indigo-400 rounded-md py-2 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                type="text"
                placeholder={placeholder[l].message}
                value={message}
                onChange={(e) => setMessage(e.target.value)}
              />
              <button
                className="transition-all duration-300 ease-in-out rounded-md bg-indigo-400 text-white w-40 px-4 py-2 font-semibold hover:bg-indigo-500 active:scale-95"
