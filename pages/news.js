    ...
    <div className="pt-20 cursor-default">
        ...
        <div className='grid lg:grid-cols-3 gap-10 md:grid-cols-2 mb-10 '>
            ...
            <div key={index} className="transition-all duration-300 ease-in-out border group border-gray-100 overflow-hidden rounded-lg ">
                <div className='transition-all duration-300 ease-in-out w-full aspect-w-16 aspect-h-9 bg-cover bg-center group-hover:opacity-90 group-hover:scale-105' style={{'backgroundImage': `url(${base+news.cover}`}} onClick={() => { router.push(`/news/${news.path}`)}} >    
                </div>
                <div className="p-5">
