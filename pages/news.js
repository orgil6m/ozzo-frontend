...
const News = ({ NewsData }) => {
    ...
    console.log(NewsLocale[`${l}`].title)
    return (
    <div className="pt-20">
        <Head>
        ...
        <div className='transition-all duration-1000 ease-in-out lg:w-full font-semibold text-2xl flex items-center text-gray-800 mb-20'> 
