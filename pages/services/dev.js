...
import cover from "../../Assets/DEV/dev_cover.jpg";
    ...
    <div className="pt-20 ">
      ...
      <div className="lg:px-32 md:px-20 lg:mt-10 p-5">
        ...
        <div className="lg:mb-10 mb-5 flex cursor-default">
          <p
            className="transition-all duration-300 ease-in-out text-sm text-gray-700/80 pr-2 hover:text-black"
            onClick={() => router.push("/")}
          >
            {" "}
            {t.home}{" "}
          ...
          <p className="transition-all duration-300 ease-in-out text-sm text-gray-700/80 hover:text-black">
            {" "}
            {t.service[5].title}{" "}
          </p>
        </div>
        ...
        <div className="w-full ">
          <div className="grid lg:grid-cols-2">
            ...
            >
              <p className="text-justify">{locale.about}</p>
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 md:gap-10 gap-5 mb-20 mt-10">
          {locale.services.map((row, index) => (
            <motion.div
              ...
              key={index}
              className="flex flex-col md:mb-5"
            >
              ...
              <p className="text-sm py-5 md:pr-5 text-justify">{row.text}</p>
            </motion.div>
          ))}
        </div>
        ...
        <motion.div
          ...
          transition={{ type: "spring", duration: 3 }}
          className="my-10 grid md:grid-cols-2 gap-10 mb-20"
        >
          <motion.div
            className="relative mt-5 w-full aspect-w-16 aspect-h-9 bg-center bg-cover rounded-lg overflow-hidden"
            style={{ backgroundImage: `url(${daavkatunes.src}` }}
            onClick={() => router.push("https://www.daavkatunes.mn")}
          >
          ...
          <motion.div
            className="relative mt-5 w-full aspect-w-16 aspect-h-9 bg-center bg-cover rounded-lg overflow-hidden"
            style={{ backgroundImage: `url(${NFT.src}` }}
            onClick={() => router.push("https://www.ard.art")}
          >
            <div className="transition-all duration-300 ease-in-out opacity-0 hover:opacity-100 backdrop-blur-sm backdrop-brightness-75  w-full h-full flex justify-center items-center rounded-lg flex-col">
              <span className="text-xl font-bold text-white">
